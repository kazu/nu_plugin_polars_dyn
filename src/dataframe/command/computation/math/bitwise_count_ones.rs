...
#[derive(Clone)]
pub struct ExprMathBitwiseCountOnes;

impl PluginCommand for ExprMathBitwiseCountOnes {
    ...
    fn search_terms(&self) -> Vec<&str> {
        vec!["bitwise", "count", "ones", "popcount"]
    }
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().bitwise_count_ones())
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathBitwiseCountOnes)
    }
}
