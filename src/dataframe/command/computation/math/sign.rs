...
#[derive(Clone)]
pub struct ExprMathSign;

impl PluginCommand for ExprMathSign {
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().sign()).to_pipeline_data(plugin, engine, call.head)
}
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathSign)
    }
}
