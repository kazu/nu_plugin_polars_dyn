...
impl PluginCommand for ExprMathBitwiseTrailingOnes {
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().bitwise_trailing_ones())
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathBitwiseTrailingOnes)
    }
}
