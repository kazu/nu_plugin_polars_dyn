...
impl PluginCommand for ExprMathSqrt {
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().sqrt()).to_pipeline_data(plugin, engine, call.head)
}
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathSqrt)
    }
}
