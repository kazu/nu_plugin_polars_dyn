...
#[derive(Clone)]
pub struct ExprMathBitwiseXor;

impl PluginCommand for ExprMathBitwiseXor {
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().bitwise_xor()).to_pipeline_data(plugin, engine, call.head)
}
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathBitwiseXor)
    }
}
