...
#[derive(Clone)]
pub struct ExprMathSin;

impl PluginCommand for ExprMathSin {
...
fn command_expr(
    ...
    NuExpression::from(expr.into_polars().sin()).to_pipeline_data(plugin, engine, call.head)
}
...
mod test {
    ...
    fn test_examples() -> Result<(), ShellError> {
        test_polars_plugin_command(&ExprMathSin)
    }
}
