...
# clean な main の上で Cargo.toml と seekzstdsep-scan / ssh-scan の pin と docs/custom_build.md の例を
...
export def release [
    ...
    for manifest in [seekzstdsep-scan/Cargo.toml ssh-scan/Cargo.toml] {
        open --raw $manifest
    ...
    ^git add Cargo.toml Cargo.lock seekzstdsep-scan/Cargo.toml ssh-scan/Cargo.toml docs/custom_build.md
